...
class Kareem {
  ...
  execPre(name, context, args, callback) {
  ...
  execPost(name, context, args, options, callback) {
  ...
  execPostSync(name, context, args) {
  ...
  wrap(name, fn, context, args, options) {
  ...
  createWrapper(name, fn, context, options) {
    var _this = this;
  ...
  pre(name, isAsync, fn, error, unshift) {
    let options = {};
